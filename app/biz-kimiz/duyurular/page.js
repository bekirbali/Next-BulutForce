          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-black/50 p-6 rounded-md max-w-2xl text-center">
              ...
              <p className="text-white">
                Stay updated with the latest news and developments from our
                company. Here you'll find important announcements, upcoming
                events, and other significant updates about our activities and
                achievements.
              </p>
            </div>
          </div>
